...
import type { UpdateFieldObject as _power_UpdateFieldObject, UpdateFieldObject__Output as _power_UpdateFieldObject__Output } from '../power/UpdateFieldObject';
...
export interface PowerServiceClient extends grpc.Client {
  ...
  AddFieldToOutput(argument: _power_UpdateFieldObject, metadata: grpc.Metadata, options: grpc.CallOptions, callback: grpc.requestCallback<_power_ResponseCode__Output>): grpc.ClientUnaryCall;
  AddFieldToOutput(argument: _power_UpdateFieldObject, metadata: grpc.Metadata, callback: grpc.requestCallback<_power_ResponseCode__Output>): grpc.ClientUnaryCall;
  AddFieldToOutput(argument: _power_UpdateFieldObject, options: grpc.CallOptions, callback: grpc.requestCallback<_power_ResponseCode__Output>): grpc.ClientUnaryCall;
  AddFieldToOutput(argument: _power_UpdateFieldObject, callback: grpc.requestCallback<_power_ResponseCode__Output>): grpc.ClientUnaryCall;
  addFieldToOutput(argument: _power_UpdateFieldObject, metadata: grpc.Metadata, options: grpc.CallOptions, callback: grpc.requestCallback<_power_ResponseCode__Output>): grpc.ClientUnaryCall;
  addFieldToOutput(argument: _power_UpdateFieldObject, metadata: grpc.Metadata, callback: grpc.requestCallback<_power_ResponseCode__Output>): grpc.ClientUnaryCall;
  addFieldToOutput(argument: _power_UpdateFieldObject, options: grpc.CallOptions, callback: grpc.requestCallback<_power_ResponseCode__Output>): grpc.ClientUnaryCall;
  addFieldToOutput(argument: _power_UpdateFieldObject, callback: grpc.requestCallback<_power_ResponseCode__Output>): grpc.ClientUnaryCall;
  ...
  UpdateField(argument: _power_UpdateFieldObject, callback: grpc.requestCallback<_power_ResponseCode__Output>): grpc.ClientUnaryCall;
  updateField(argument: _power_UpdateFieldObject, metadata: grpc.Metadata, options: grpc.CallOptions, callback: grpc.requestCallback<_power_ResponseCode__Output>): grpc.ClientUnaryCall;
  updateField(argument: _power_UpdateFieldObject, metadata: grpc.Metadata, callback: grpc.requestCallback<_power_ResponseCode__Output>): grpc.ClientUnaryCall;
  updateField(argument: _power_UpdateFieldObject, options: grpc.CallOptions, callback: grpc.requestCallback<_power_ResponseCode__Output>): grpc.ClientUnaryCall;
  updateField(argument: _power_UpdateFieldObject, callback: grpc.requestCallback<_power_ResponseCode__Output>): grpc.ClientUnaryCall;
...
export interface PowerServiceHandlers extends grpc.UntypedServiceImplementation {
  ...
  AddFieldToOutput: grpc.handleUnaryCall<_power_UpdateFieldObject__Output, _power_ResponseCode>;
...
export interface PowerServiceDefinition extends grpc.ServiceDefinition {
  ...
  AddFieldToOutput: MethodDefinition<_power_UpdateFieldObject, _power_ResponseCode, _power_UpdateFieldObject__Output, _power_ResponseCode__Output>
